...
class Result(models.Model):
    ...
    semester7_module6 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='semester7_module6_results',null=True)
    ...
    semester7_gradepoint6 = models.TextField(max_length=2,null=True)
    ...
    semester7_grade6 = models.CharField(max_length=1, null=True)
    ...
    semester8_module5 = models.ForeignKey(year4_semester2, on_delete=models.CASCADE, related_name='semester8_module5_results',null=True)
    semester8_module6 = models.ForeignKey(year4_semester2, on_delete=models.CASCADE, related_name='semester8_module6_results',null=True)
    ...
    semester8_gradepoint5 = models.TextField(max_length=2,null=True)
    semester8_gradepoint6 = models.TextField(max_length=2,null=True)
    ...
    semester8_equivalent5 = models.IntegerField(null=True)
    ...
    semester8_grade5 = models.CharField(max_length=1, null=True)
    semester8_grade6 = models.CharField(max_length=1, null=True)
...
class BitResult(models.Model):
    ...
    # =====================YEAR ONE=========================================#
    # ****************SEMESTER ONE************************
    module1 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module1_results',null=True,default='')
    module2 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module2_results',null=True,default='')
    module3 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module3_results',null=True,default='')
    module4 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module4_results',null=True,default='')
    module5 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module5_results',null=True,default='')
    module6 = models.ForeignKey(year1_semester1, on_delete=models.CASCADE, related_name='bit_module6_results',null=True,default='')
    module_grade1 = models.IntegerField(null=True,default='')
    module_grade2 = models.IntegerField(null=True,default='')
    module_grade3 = models.IntegerField(null=True,default='')
    module_grade4 = models.IntegerField(null=True,default='')
    ...
    # ****************SEMESTER TWO************************
    semester2_module1 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module1_results',null=True)
    semester2_module2 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module2_results',null=True)
    semester2_module3 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module3_results',null=True)
    semester2_module4 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module4_results',null=True)
    semester2_module5 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module5_results',null=True)
    semester2_module6 = models.ForeignKey(year1_semester2, on_delete=models.CASCADE, related_name='bit_semester2_module6_results',null=True)
    semester2_module_grade1 = models.IntegerField(null=True)
    semester2_module_grade2 = models.IntegerField(null=True)
    semester2_module_grade3 = models.IntegerField(null=True)
    semester2_module_grade4 = models.IntegerField(null=True)
    ...
    # =========================SECOND YEAR=================================================#
    # ****************SEMESTER THREE************************
    semester3_module1 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module1_results',null=True)
    semester3_module2 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module2_results',null=True)
    semester3_module3 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module3_results',null=True)
    semester3_module4 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module4_results',null=True)
    semester3_module5 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module5_results',null=True)
    semester3_module6 = models.ForeignKey(year2_semester1, on_delete=models.CASCADE, related_name='bit_semester3_module6_results',null=True)
    semester3_module_grade1 = models.IntegerField(null=True)
    semester3_module_grade2 = models.IntegerField(null=True)
    semester3_module_grade3 = models.IntegerField(null=True)
    semester3_module_grade4 = models.IntegerField(null=True)
    ...
    semester3_totalsch = models.IntegerField(null=True, default=0)
     ...
     # ****************SEMESTER FOUR************************
    semester4_module1 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module1_results',null=True)
    semester4_module2 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module2_results',null=True)
    semester4_module3 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module3_results',null=True)
    semester4_module4 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module4_results',null=True)
    semester4_module5 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module5_results',null=True)
    semester4_module6 = models.ForeignKey(year2_semester2, on_delete=models.CASCADE, related_name='bit_semester4_module6_results',null=True)
    semester4_module_grade1 = models.IntegerField(null=True)
    semester4_module_grade2 = models.IntegerField(null=True)
    semester4_module_grade3 = models.IntegerField(null=True)
    semester4_module_grade4 = models.IntegerField(null=True)
    ...
    year2_cgpa = models.DecimalField(max_digits=5, decimal_places=2, null=True)
     ...
     # =========================THIRD YEAR=================================================#
    # ****************SEMESTER FIVE************************
    semester5_module1 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module1_results',null=True, blank=True)
    semester5_module2 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module2_results',null=True)
    semester5_module3 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module3_results',null=True)
    semester5_module4 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module4_results',null=True)
    semester5_module5 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module5_results',null=True)
    semester5_module6 = models.ForeignKey(year3_semester1, on_delete=models.CASCADE, related_name='bit_semester5_module6_results',null=True)
    semester5_module_grade1 = models.IntegerField(null=True)
    semester5_module_grade2 = models.IntegerField(null=True)
    semester5_module_grade3 = models.IntegerField(null=True)
    semester5_module_grade4 = models.IntegerField(null=True)
    ...
    semester5_totalsch = models.IntegerField(null=True, default=0)
     ...
     # ****************SEMESTER SIX************************
    semester6_module1 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module1_results',null=True)
    semester6_module2 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module2_results',null=True)
    semester6_module3 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module3_results',null=True)
    semester6_module4 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module4_results',null=True)
    semester6_module5 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module5_results',null=True)
    semester6_module6 = models.ForeignKey(year3_semester2, on_delete=models.CASCADE, related_name='bit_semester6_module6_results',null=True)
    semester6_module_grade1 = models.IntegerField(null=True)
    semester6_module_grade2 = models.IntegerField(null=True)
    semester6_module_grade3 = models.IntegerField(null=True)
    semester6_module_grade4 = models.IntegerField(null=True)
    ...
    year3_cgpa = models.DecimalField(max_digits=5, decimal_places=2, null=True)
     ...
     # ****************SEMESTER SEVEN************************
    semester7_module1 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='bit_semester7_module1_results',null=True)
    semester7_module2 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='bit_semester7_module2_results',null=True)
    semester7_module3 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='bit_semester7_module3_results',null=True)
    semester7_module4 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='bit_semester7_module4_results',null=True)
    semester7_module5 = models.ForeignKey(year4_semester1, on_delete=models.CASCADE, related_name='bit_semester7_module5_results',null=True)
    semester7_module_grade1 = models.IntegerField(null=True)
    semester7_module_grade2 = models.IntegerField(null=True)
    semester7_module_grade3 = models.IntegerField(null=True)
    semester7_module_grade4 = models.IntegerField(null=True)
    ...
    semester7_totalsch = models.IntegerField(null=True, default=0)
     ...
     # ****************SEMESTER EIGHT************************
    semester8_module1 = models.ForeignKey(year4_semester2, on_delete=models.CASCADE, related_name='bit_semester8_module1_results',null=True)
    semester8_module2 = models.ForeignKey(year4_semester2, on_delete=models.CASCADE, related_name='bit_semester8_module2_results',null=True)
    semester8_module3 = models.ForeignKey(year4_semester2, on_delete=models.CASCADE, related_name='bit_semester8_module3_results',null=True)
    semester8_module_grade1 = models.IntegerField(null=True)
    semester8_module_grade2 = models.IntegerField(null=True)
    semester8_module_grade3 = models.IntegerField(null=True)
    semester8_gradepoint1 = models.TextField(max_length=2,null=True)
