...
class DepartmentForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'department': forms.TextInput(attrs={'class': 'form-control shadow-none', 'oninput': "this.value = this.value.replace(/[^a-zA-Z ]/g, '')", 'placeholder': 'Department'}),
        }
...
class ProgramForm(ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'program': forms.TextInput(attrs={'class': 'form-control shadow-none', 'oninput': "this.value = this.value.replace(/[^a-zA-Z ]/g, '')",'placeholder':'Program'}),
        }
...
class StudentForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'email': forms.TextInput(attrs={'class': 'form-control shadow-none','placeholder':'Email'}),
